...
public class ExternalAttributeDbAdapter extends DbAdapter {
  ...
  public static final String[] KEYS = 
      {KEY_EXTERNALATTRIBUTEID, KEY_EXTERNALATTRIBUTENAME, KEY_APPID, KEY_DATATYPEID};
  ...
  /**
   * Constructor.
   * @param database is the context to work within.
   */
   ...
   * @param appID is the application id that it belongs to
   * @param dataTypeID is the dataType id that it belongs to
  ...
  public Cursor fetch(Long attributeID) {
    ...
    Cursor mCursor = database.query(true, 
        DATABASE_TABLE, KEYS, KEY_EXTERNALATTRIBUTEID + "=" + attributeID, 
   ...
   * @param attributeName is the attribute name, or null to fetch any actionName
  ...
  public boolean update(Long attributeID, String attributeName, Long appID, Long dataTypeID) {
    ...
    if (args.size() > 0) {
      ...
      return database.update(DATABASE_TABLE, args, 
          KEY_EXTERNALATTRIBUTEID + "=" + attributeID, null) > 0;
    }
    return false;
  }
}

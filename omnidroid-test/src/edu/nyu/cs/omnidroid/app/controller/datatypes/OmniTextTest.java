...
public class OmniTextTest extends TestCase {
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.app.controller.datatypes.OmniText#OmniText(java.lang.Object)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.app.controller.datatypes.OmniText#matchFilter(DataType.Filter, DataType)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.app.controller.datatypes.OmniText#validateUserDefinedValue(java.lang.String, java.lang.String)}
   * .
   */
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.app.controller.datatypes.OmniText#isValidFilter(java.lang.String)}.
   */

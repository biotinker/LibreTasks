...
public class OmniAreaTest extends AndroidTestCase {
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getFilterFromString(java.lang.String)}.
   */
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#OmniArea(java.lang.String)}
   * . Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#toString()} .
   * 
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#equals(java.lang.Object)} .
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#OmniArea 
   * (java.lang.String, double, double, double)} .
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#hashCode()} .
   * 
   * @throws DataTypeValidationException
   */
   ...
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#OmniArea 
   * (edu.nyu.cs.omnidroid.core.datatypes.OmniArea)} .
   * @throws DataTypeValidationException 
   */
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getOmniArea (android.content.Context, 
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#matchFilter 
   * (edu.nyu.cs.omnidroid.core.datatypes.OmniArea.Filter,
   *  edu.nyu.cs.omnidroid.core.datatypes.OmniArea)}
   * . Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getDistance 
   * (edu.nyu.cs.omnidroid.core.datatypes.OmniArea, edu.nyu.cs.omnidroid.core.datatypes.OmniArea)}
   * .
   */
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getLatitude()}.
   */
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getLongitude()}.
   */
  ...
  /**
   * Test method for {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getProximityDistance()}.
   */
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#validateUserDefinedValue 
  ...
  /**
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#isValidFilter(java.lang.String)}.
   */
   ...
   * Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#matchFilter 
   * (edu.nyu.cs.omnidroid.core.datatypes.DataType.Filter,
   *  edu.nyu.cs.omnidroid.core.datatypes.DataType)}
   * . Test method for
   * {@link edu.nyu.cs.omnidroid.core.datatypes.OmniArea#getDistance 
   * (edu.nyu.cs.omnidroid.core.datatypes.OmniArea, edu.nyu.cs.omnidroid.core.datatypes.OmniArea)}
   * .

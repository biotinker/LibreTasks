 ...
 */
public class DlgFilterInput extends Dialog implements FactoryFilterToUI.IDlgFilterInput {
  /**
   ...
   */
  private FactoryFilterToUI.IFilterInputDone mHandlerFilterInputDone;
   ...
   */
  private FactoryFilterToUI.IDlgPreserveState mHandlerStatePreserver;
                        ...
                        DataType dataOld) 
  {
    ...
    FactoryFilterToUI.buildUIForFilter(this, attribute, filter, dataOld);
  ...
  private android.view.View.OnClickListener listenerBtnClickOk = new android.view.View.OnClickListener() {
    public void onClick(View v) {
      ...
      ModelFilter filter;
      try {
        filter = mHandlerFilterInputDone.onFilterInputDone();
      } catch (Exception ex) {
      ...
      FilterBuilder.instance().setFilter(filter);
  ...
  /** Implements FactoryFilterToUI.IDlgFilterInput. */
  public void setHandlerOnFilterInputDone(FactoryFilterToUI.IFilterInputDone handler) {
    mHandlerFilterInputDone = handler;
  }

  public void setHandlerPreserveState(FactoryFilterToUI.IDlgPreserveState handler) {

...
public class RegisteredActionParameterDbAdapter extends DbAdapter {
  ...
  public static final String[] KEYS = 
      {KEY_ACTIONPARAMETERID, KEY_ACTIONPARAMETERNAME, KEY_ACTIONID, KEY_DATATYPEID};
   ...
   * @param actionID is the id of the action it belongs to.
   ...
   * @param parameterID is the id of the record.
   * @return true if success, or false otherwise.
   * @throw IllegalArgumentException if parameterID is null
   */
   ...
   * @param parameterID is the parameter id
  ...
  public Cursor fetch(Long parameterID) {
    ...
    Cursor mCursor = database.query(true, DATABASE_TABLE, KEYS, 
        KEY_ACTIONPARAMETERID + "=" + parameterID, null, null, null, null, null);
    if (mCursor != null) {
      mCursor.moveToFirst();
    }
    return mCursor;
   ...
   * @param parameterName is the parameter name, or null to fetch any parameterName.
   * @param actionID is the action id, or null to fetch any actionID.
   ...
   * @param parameterID is the id of the record to be updated.
   * @param parameterName is the parameter name, or null if not updating it.
   * @param actionID is the action id, or null if not updating it.
  ...
  public boolean update(Long parameterID, String parameterName, Long actionID, Long dataTypeID) {
    ...
    if (args.size() > 0) {
      ...
      return database.update(
          DATABASE_TABLE, args, KEY_ACTIONPARAMETERID + "=" + parameterID, null) > 0;
    }
    return false; 
  }

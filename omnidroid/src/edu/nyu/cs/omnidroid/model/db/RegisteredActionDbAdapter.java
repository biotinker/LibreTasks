...
public class RegisteredActionDbAdapter extends DbAdapter {
   ...
   * @param actionName is the actionName
   ...
   * @throw IllegalArgumentException if actionID is null 
   */
   ...
   * @param actionName is the actionName, or null to fetch any actionName
   ...
   * @param actionID is the id of the record to be updated.
   * @param actionName is the action name, or null if not updating it.

...
public class DataFilterDbAdapter extends DbAdapter {
   ...
   * @param dataFilterName is the name of the filter.
   * @param dataTypeID is the id of data type it belongs to.
   ...
   * @param dataFilterID is the id of the record.
   * @return true if success, or false otherwise.
   * @throw IllegalArgumentException if dataFilterID is null
   */
   ...
   * @param dataFilterID is the id of the record to be fetched.
  ...
  public Cursor fetch(Long dataFilterID) {
    ...
    Cursor mCursor = database.query(true, DATABASE_TABLE, KEYS, 
        KEY_DATAFILTERID + "=" + dataFilterID, null, null, null, null, null);
    if (mCursor != null) {
      mCursor.moveToFirst();
    }
    return mCursor;
   ...
   * @param dataFilterName is the filter name or null to fetch any filter name.
   * @param dataTypeID is id of the data type it belongs to, or null to fetch any dataTypeID.
   * @return a Cursor that contains all DataFilter records which matches the parameters.
   */
   ...
   * @param dataFilterID is the id of the record to be updated.
   * @param dataFilterName is the application name or null if not updating it.
   * @param dataTypeID is the package name or null if not updating it.
   * @return true if success, or false otherwise.
   * @throw IllegalArgumentException if dataFilterID is null
   */

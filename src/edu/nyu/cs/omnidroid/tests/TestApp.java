...
public class TestApp extends ListActivity {
	...
	static final String[] TESTS = new String[] { "Test User Config",
			"Test App Config", "Test CP", "Test Exception Handler",
			"Test Service", "TestApp", "PackageLister", "External Event App" };
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
		case 0:
			i.setClassName(this.getApplicationContext(),
		...
		case 4:
			i.setClassName(this.getApplicationContext(),
					"edu.nyu.cs.omnidroid.tests.TestService");
			break;
		case 5:
			i.setClassName(this.getApplicationContext(),
		...
		case 6:
			i.setClassName(this.getApplicationContext(),
					"edu.nyu.cs.omnidroid.ui.PackageLister");
			break;
		case 7:
			i.setClassName(this.getApplicationContext(),
					"edu.nyu.cs.omnidroid.external.eventapp.ExternalCPActivity");
			break;
		default:

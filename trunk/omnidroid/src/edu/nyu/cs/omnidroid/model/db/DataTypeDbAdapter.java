...
public class DataTypeDbAdapter extends DbAdapter {
   ...
   * @param dataTypeClassName is the name of the data type class.
   ...
   * @param dataTypeID is the id of the record.
   * @return true if success, or false otherwise.
   * @throw IllegalArgumentException if dataTypeID is null
   */
   ...
   * @param dataTypeID is the id of the record to be fetched.
  ...
  public Cursor fetch(Long dataTypeID) {
    ...
    Cursor mCursor = database.query(true, DATABASE_TABLE, KEYS, 
        KEY_DATATYPEID + "=" + dataTypeID, null, null, null, null, null);
    if (mCursor != null) {
      mCursor.moveToFirst();
    }
    return mCursor;
   ...
   * @param dataTypeName is the data type name or null to fetch any dataTypeName.
   * @param dataTypeClassName is the name of the data type class.
   * @return a Cursor that contains all DataType records which matches the parameters.
   */
   ...
   * @param dataTypeID is the id of the record to be updated.
   * @param dataTypeName is the data type name or null if not updating it.
   * @param dataTypeClassName is the name of the data type class.
   * @return true if success, or false otherwise.
   * @throw IllegalArgumentException if dataTypeID is null
   */

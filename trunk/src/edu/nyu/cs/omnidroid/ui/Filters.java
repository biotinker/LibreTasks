...
public class Filters extends Activity implements OnClickListener {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		// TODO(acase): For edit
		/*
		 * StringMap sm = (StringMap) l.getAdapter().getItem(position); Intent i
		 * = new Intent(); i.setClass(this.getApplicationContext(),
		 * FiltersAdd.class); i.putExtra(AGParser.KEY_APPLICATION, appName);
		 * i.putExtra(UGParser.KEY_EventName, eventName);
		 * i.putExtra(UGParser.KEY_FilterType, sm.getKey());
		 * i.putExtra(UGParser.KEY_FilterData, sm.getValue()); startActivity(i);
		 * finish();
		 */
	}

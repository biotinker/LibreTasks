...
public class OmniCPActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
      ...
      public void onClick(View v) {
        ...
        if (text1.length() > 0 && sname.length() > 0 && sphno.length() > 0) {
          ...
          Uri uri = getContentResolver().insert(
              Uri.parse("content://com.omnidroid.provider.CP/CP"), values);
    ...
    Retrieve.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        ...
        if (id.length() > 0) {
          Uri OmniURI = Uri.parse("content://com.omnidroid.provider.CP/CP");
          ...
          if (c.moveToPosition(new_id)) {
            Toast.makeText(
                ...
                c.getString(c.getColumnIndex(OmniCP._ID)) + ", "
                    + c.getString(c.getColumnIndex(OmniCP.S_NAME)) + ", "
                    + c.getString(c.getColumnIndex(OmniCP.S_PH_NO)) + ", "
                    + c.getString(c.getColumnIndex(OmniCP.TEXT)), Toast.LENGTH_LONG).show();
          }

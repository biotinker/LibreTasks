...
public class FactoryDataType {
	...
	/*
	 * TODO (dvo203): The package name is temporary measure, once all the
	 * packages are settled and defined, it should be removed. The complete
	 * package name and class should be stored in the database.
	 */
	private static final String packageName = "edu.nyu.cs.omnidroid.model.ApplicationConfiguration";
	...
	/*
	 * * Factory method that creates the object of className type and
	 * initialized with provided value
	 * 
	 * @param className - string representing Omnidroid class name. Must
	 * implement DataType.
	 * 
	 * @param value - the string value to initialize object with. Note: if value
	 * is not valid, no object will be created and null will be returned.
	 * 
	 * @return the DataType object if object was successfully created, or null
	 * if failed.
	 */

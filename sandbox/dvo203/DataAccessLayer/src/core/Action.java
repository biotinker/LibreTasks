...
/**
 * Action provides a general wrapper for the intent to be fired. Classes that extend Action should
 * provide the intent to be fired and execution method used to fire the intent.
 */
public abstract class Action {
  ...
  public abstract String getParameter(int index) throws IndexOutOfBoundsException;

  public abstract void setParameter(int index, String value) throws IndexOutOfBoundsException;

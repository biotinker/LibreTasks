...
public class CoreActionsDbHelper {
  ...
  private Action getAction(String appName, String actionName, HashMap<String, String> actionParams)
    ...
    } else if (appName.equals(NotePadAction.APP_NAME)
    		&& actionName.equals(NotePadAction.ACTION_NAME)) {
    	Log.d("CoreActionsDbHelper", "NotePadAction created");
    	return new NotePadAction(actionParams);
    } else {
    	Log.d("CoreActionsDbHelper", "doesn't catch NotePadAction: the AppName is: " + appName + 
    			" and actionName is: " + actionName);
    	Log.d("CoreActionsDbHelper", "In NotePadAction the AppName is: " + NotePadAction.APP_NAME + 
    			" and actionName is: " + NotePadAction.ACTION_NAME);

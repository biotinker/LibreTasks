...
public class RuleProcessor {
   ...
   */
  public static List<Action> getActions(Event event, CoreRuleDbHelper coreRuleDbHelper,
      CoreActionsDbHelper coreActionsDbHelper) {

    List<Rule> rules = coreRuleDbHelper.getRulesMatchingEvent(event.getAppName(), event.getEventName());
